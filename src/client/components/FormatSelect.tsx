...
const FORMAT_GROUPS: Record<string, string[]> = {
  Web:       ["webp", "avif", "png", "jpeg", "jpg"],
  Document:  ["pdf", "svg"],
  Other:     ["gif", "bmp", "tiff", "heic"],
};

export function FormatSelect({ value, onChange }: Props) {
  return (
    <Select.Root value={value} onValueChange={(v) => onChange(v as ImageFormat)}>
